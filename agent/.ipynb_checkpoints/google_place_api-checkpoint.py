...
class GooglePlaceAPI:
    ...
    def text_search(self, text_query) -> dict:
        ...
        headers = {
            ...
            "X-Goog-FieldMask": "places.displayName,places.formattedAddress,places.rating,places.websiteUri,places.regularOpeningHours,places.googleMapsLinks,places.photos",
        }
        ...
        if response.status_code == 200:
            ...
            if places:
                return self._extract_property_from_results(places[0]), response
            else:
                return {}
        else:
